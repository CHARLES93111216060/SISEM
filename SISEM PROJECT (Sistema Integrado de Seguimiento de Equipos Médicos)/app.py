...
def load_form(form_type):
    ...
    forms = {
        ...
        'infusion': 'forms/protocolos_mantenimiento/bomba_infusion.html',
        'cama': 'forms/protocolos_mantenimiento/cama_hospitalaria.html',
        'concentrador': 'forms/protocolos_mantenimiento/concentrador_O2.html',
        'desfibrilador': 'forms/protocolos_mantenimiento/desfibrilador.html',
        'bisturi': 'forms/protocolos_mantenimiento/electrobisturi.html',
        'cardiografo': 'forms/protocolos_mantenimiento/electrocardiografo.html',
        'flujometro': 'forms/protocolos_mantenimiento/flujometro.html',
        'incubadora': 'forms/protocolos_mantenimiento/incubadora.html',
        'anestesia': 'forms/protocolos_mantenimiento/maquina_anestesia.html',
        'signos_vitales': 'forms/protocolos_mantenimiento/monitor_signos_vitales.html',
        'neveras': 'forms/protocolos_mantenimiento/neveras.html',
        'oximetro': 'forms/protocolos_mantenimiento/oximetro.html',
        'succionador': 'forms/protocolos_mantenimiento/succionador.html',
        'tensiometro': 'forms/protocolos_mantenimiento/tensiometro.html',
